Yu Guo  yg2683@columbia.edu  Homework 1
...
The model selection portion has been commented out. Concretely, commented out are the two alternative main() functions I used to automatically try the feature/classifier combination for each of the two models as listed in the written PDF.